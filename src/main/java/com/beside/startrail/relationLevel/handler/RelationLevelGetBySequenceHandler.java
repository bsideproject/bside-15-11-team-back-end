...
@Component
public class RelationLevelGetBySequenceHandler extends AbstractSignedHandler {

    private final RelationLevelService relationLevelService;

    public RelationLevelGetBySequenceHandler(@Value("${sign.attributeName}") String attributeName,
    ...
    protected Mono<ServerResponse> signedHandle(ServerRequest serverRequest) {
        ...
        return relationLevelService.getRelationLevelBySequence(sequence)
